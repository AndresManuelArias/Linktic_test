...
import com.tienda.products.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.tienda.products.domain.Product}.
 */
@RestController
...
public class ProductResource {
    ...
    @Value("${jhipster.clientApp.name:products}")
