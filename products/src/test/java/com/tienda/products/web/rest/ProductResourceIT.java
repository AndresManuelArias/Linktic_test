package com.tienda.products.web.rest;

import static com.tienda.products.domain.ProductAsserts.*;
import static com.tienda.products.web.rest.TestUtil.createUpdateProxyForBean;
import static com.tienda.products.web.rest.TestUtil.sameNumber;
...
import com.tienda.products.IntegrationTest;
import com.tienda.products.domain.Product;
import com.tienda.products.domain.enumeration.ProductStatus;
...
class ProductResourceIT {
    ...
    public static Product createEntity() {
        return new Product().sku(DEFAULT_SKU).name(DEFAULT_NAME).price(DEFAULT_PRICE).status(DEFAULT_STATUS).createdAt(DEFAULT_CREATED_AT);
    }
    ...
    public static Product createUpdatedEntity() {
        return new Product().sku(UPDATED_SKU).name(UPDATED_NAME).price(UPDATED_PRICE).status(UPDATED_STATUS).createdAt(UPDATED_CREATED_AT);
    }
    ...
    void putExistingProduct() throws Exception {
        ...
        updatedProduct.sku(UPDATED_SKU).name(UPDATED_NAME).price(UPDATED_PRICE).status(UPDATED_STATUS).createdAt(UPDATED_CREATED_AT);
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.sku(UPDATED_SKU).name(UPDATED_NAME).price(UPDATED_PRICE);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.sku(UPDATED_SKU).name(UPDATED_NAME).price(UPDATED_PRICE).status(UPDATED_STATUS).createdAt(UPDATED_CREATED_AT);
